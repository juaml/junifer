...
class HTCondorAdapter(QueueContextAdapter):
    ...
    def prepare(self) -> None:
        ...
        self._pre_run_path.write_text(textwrap.dedent(self.pre_run_cmds()))
        ...
        self._submit_run_path.write_text(textwrap.dedent(self.run_cmds()))
        # Create pre collect
        logger.info(
        ...
        self._pre_collect_path.write_text(
            textwrap.dedent(self.pre_collect_cmds())
        )
        ...
        self._submit_collect_path.write_text(
            textwrap.dedent(self.collect_cmds())
        )
        # Create DAG
        logger.debug(
        ...
        self._dag_path.write_text(textwrap.dedent(self.dag_cmds()))
        # Submit if required
