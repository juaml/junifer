"""Provide class for native space warping via FSL FLIRT."""
...
class FSLNativeWarper:
    """Class for native space warping via FSL FLIRT.
    ...
    def preprocess(
        ...
        """
        logger.debug("Using FSL for native space warping")
